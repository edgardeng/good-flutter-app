...
//        newMovieList = newMovieData;
        banners = [
          new MovieTopBanner(weeklyList, '一周口碑电影榜', '每周五更新·共10部', 'weekly', AppColor.darkGrey), // paletteGenerator1.darkVibrantColor),
          new MovieTopBanner(top250List, '豆瓣电影Top250', '豆瓣榜单·共250部', 'top250',AppColor.darkGrey),
          new MovieTopBanner(newMovieList, '一周新电影榜', '每周五更新·共10部', 'new_movies',AppColor.darkGrey),
          new MovieTopBanner(usBoxList, '北美电影票房榜', '每周五更新·共10部', 'us_box', AppColor.darkGrey)
        ];
      });
  }
